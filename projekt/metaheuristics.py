...
def simulated_annealing(
    ...
    Parameters:
        ...
        initial_solution - initial solution for a given function
    ...
    while (
        now() - start <= timeout
        and temperature > 0
        and now() - last_best < local_timeout
    ):
        tweaked_solution = tweak(
            deepcopy(current_solution) if deep_input else current_solution
        )
